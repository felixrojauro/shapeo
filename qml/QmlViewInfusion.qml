...
CQmlViewInfusion
{
	...
	Image
	{
		...
		ColumnLayout
		{
			...
			{
				id: id_title
				objectName: id_viewInfusion.objectName + "_Title"
				height: 100
			...
			{
				id: id_button_Play
				objectName: id_viewInfusion.objectName + "_ButtonPlay"
				...
				states:
					...
					State
					{
						...
						PropertyChanges
						{
							...
							objectName: id_viewInfusion.objectName + "_ButtonPlay_Start"
						}
					},
					State
					{
						...
						PropertyChanges
						{
							...
							objectName: id_viewInfusion.objectName + "_ButtonPlay_Stop"
						}
					}
				]
			}
			...
			{
				id: id_button_Back
				objectName: id_viewInfusion.objectName + "_ButtonBack"
