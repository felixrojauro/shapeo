...
CQmlViewPeelJet
{
	...
	Image
	{
		...
		ColumnLayout
		{
			...
			{
				id: id_title
				objectName: id_viewPeelJet.objectName + "_Title"
				height: 100
			...
			{
				id: id_button_Play
				objectName: id_viewPeelJet.objectName + "_ButtonPlay"
				...
				states:
					...
					State
					{
						...
						PropertyChanges
						{
							...
							objectName: id_viewPeelJet.objectName + "_ButtonPlay_Start"
						}
					},
					State
					{
						...
						PropertyChanges
						{
							...
							objectName: id_viewPeelJet.objectName + "_ButtonPlay_Stop"
						}
					}
				]
			}
			...
			{
				id: id_button_Back
				objectName: id_viewPeelJet.objectName + "_ButtonBack"
	...
	{
		id_title.color = MyCommon.COLOR_SHIT_VIOLET
	}
}
